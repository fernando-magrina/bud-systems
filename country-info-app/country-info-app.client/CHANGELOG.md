...
- Create Angular project with ng: `ng new country-info-app.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`country-info-app.client.esproj`).
